...
(3, 'ming@gg.com', '$2a$08$QE9RdUREn94w3J4ZD/qRFOLN/AnAyJp1uevy/33ol/ll1gX8fykJG', '0918222333', '', '1990-02-02', '52c61e86824899ca67e8d815a7a7afb0ce43878c', 0, '老明', '2019-01-07 10:39:38'),
...
(2, '吳睿紘', '圖解資料結構-使用JAVA', 1, 'PG30035', '2009-12-15', 384, 1680, '978-986-201-281-9 ', 1, '資料結構一直是電腦科學領域非常重要的基礎課程，本書是以教導如何將資料結構概念用Java程式語言來實作的重要著作。其特色在於將複雜的理論輔以圖文並茂的解說方式，搭配豐富的圖表及範例介紹，將資料結構中重要的觀念及演算法加以詮釋，集中學習焦點。\r\n每章重要理論均有範例實作，書中收錄了精華的演算法及程式的執行畫面，隨書光碟則附與完整的範例程式，提供詳盡的探討，提昇學習的成效。\r\n\r\n◎內容架構完整，邏輯清楚，採用豐富的圖例來闡述基本觀念及應用，有效提高可讀性。\r\n◎以JAVA程式語言實作資料結構中的重要理論，以範例程式說明資料結構的內涵。\r\n◎精選重點習題，參斟國家重要的考試命題重點，課後立即複習，達到事半功倍的效果。'),
...
('FW91MhMo66yUZPnFLEaLjYjxZqahy1Cf', 1634265922, '{\"cookie\":{\"originalMaxAge\":1200000,\"expires\":\"2021-10-15T02:45:17.346Z\",\"httpOnly\":true,\"path\":\"/\"},\"member\":{\"id\":3,\"email\":\"ming@gg.com\",\"nickname\":\"老明\"}}');
...
--
-- 傾印資料表的資料 `test_avatar`
--

INSERT INTO `test_avatar` (`sid`, `avatar`, `name`, `created_at`) VALUES
(1, '03c1e5c0-8723-4c7e-8eda-ad1bd1794c39.jpg', 'hello', '2021-10-14 15:10:55'),
(2, '211ab556-b79c-4e16-8020-5f5dfc7040dd.jpg', 'david lin 2', '2021-10-14 15:11:33'),
(3, '', 'bill', '2021-10-14 15:12:12'),
(4, '46e1d253-4a56-4866-8b7c-9e61d69affb5.jpg', 'bill-2', '2021-10-14 15:12:33');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `test_avatar`
--
ALTER TABLE `test_avatar`
  MODIFY `sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
